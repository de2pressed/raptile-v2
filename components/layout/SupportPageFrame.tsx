  ...
  return (
    <div id="top" className="mx-auto w-full max-w-[1120px] py-10 md:py-16">
      <div className="grid gap-8 lg:grid-cols-[220px_minmax(0,1fr)] lg:items-start">
        <div className="space-y-3 lg:sticky lg:top-[82px]">
        ...
        <div className="glass-panel noise-surface rounded-[28px] px-6 py-8 md:px-10 md:py-10">
          <div className="support-content relative z-[1]">{children}</div>
